...
In the next table is presented a compilation of several developments within IMS field. For each work a brief overview and a remark of how each component is related to it are given.
