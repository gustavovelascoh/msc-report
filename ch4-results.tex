...
% It can be seen in this table that merging laser data with video data in some cases enhance the classification task. But it should be noted that this is an unbalanced dataset, with 17.64 \% of True (Flowing traffic) instances and 82.36 \% of False (Stopped traffic),
